				...
				if($product_info['product_status'])
				{
					if(0 < $product_info['stock_on_hand'])
					{
						...
						if($_SESSION['update-order']['items']['products'][$product_info['product_id']]) //update qty
						{
							...
							$_SESSION['update-order']['items']['products'][$product_info['product_id']] = array(1, $product_info['unit_price'], $product_info['product_name'], $product_info['product_category'], $zone[$product_info['product_id']]['zone_code']);
						}
